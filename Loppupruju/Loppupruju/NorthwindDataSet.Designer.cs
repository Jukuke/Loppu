...
namespace Loppupruju {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public NorthwindDataSet(string dataSetName) : base(dataSetName)
        {
        }
...
namespace Loppupruju.NorthwindDataSetTableAdapters {
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Loppupruju.Properties.Settings.Default.Northwind;
        }
